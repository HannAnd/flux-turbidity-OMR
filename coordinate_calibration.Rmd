...
###ok, so I want to detect which file is being used and reference the appropriate
###row of 'corners'
##I can pull out the tank and recording number from the file names pretty easily,
##I'm just not sure at the moment how to make that call back to the appropriate
##row from 'corners'
...
for (d in 1:(length(list_csv))) {
  ...
  #using the file information to refer to the appropriate X,Y coordinate
  #values in the 'corners' dataframe
