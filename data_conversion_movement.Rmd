...
knitr::opts_knit$set(root.dir = "D://Clay Flux Experiment with OMR/calibrated_CSVs")
library(tidyverse)
library(data.table)
library(zoo)
...
write_csv(finalframe, "D://Clay Flux Experiment with OMR/6day_clay_movement_data.csv")
```
