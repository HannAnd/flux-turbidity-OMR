...
#recordings
hist_speed <- ggplot(claydata, aes(x = mean_speed)) + geom_histogram() +
                        labs(title = "Clay Experiment: Mean Speed",
                             subtitle = "All Speed Values") +
                        xlab("Speed (cm/s)") +
                        ylab("Counts") + theme_classic()
hist_maxspeed <- ggplot(claydata, aes(x = max_speed)) + geom_histogram() +
                        labs(title = "Clay Experiment: Max Speed",
                             subtitle = "All Max Speeds") +
                        xlab("Maximum Speed (cm/s)") +
                        ylab("Counts") + theme_classic()
hist_activ <- ggplot(claydata, aes(x = activity_ratio)) + geom_histogram() +
                        labs(title = "Clay Experiment: Activity",
                             subtitle = "All Activity Values") +
                        xlab("Ratio of Frames Spent Active to Total Frames") +
                        ylab("Counts") + theme_classic()
hist_maxaccel <- ggplot(claydata, aes(x = max_acceleration)) + geom_histogram() +
                        labs(title = "Clay Experiment: Max Acceleration",
                             subtitle = "All Max Acceleration Values") +
                        xlab("Maximum Acceleration (cm/s^2)") +
                        ylab("Counts") + theme_classic()
hist_dist <- ggplot(claydata, aes(x = totaldist_cm)) + geom_histogram() +
                        labs(title = "Clay Experiment: Distance Traveled",
                             subtitle = "All Distance Values") +
                        xlab("Total Distance Traveled (cm)") +
                        ylab("Counts") + theme_classic()
...
box_activ <- claydata %>%
                ...
                labs(title = "Clay Experiment: Activity",
                     subtitle = "Across all recordings") +
                xlab("Treatments") + ylab("Ratio of Seconds Spent Active to Total Seconds") +
                scale_fill_manual(values =
                                  c("slategray1", "wheat1", "wheat4")) +
                #ylim() +
                theme_classic()
...
#basic histogram plots to look at distributions combining all treatments and all
#recordings
hist_speed <- ggplot(dyedata, aes(x = mean_speed)) + geom_histogram() +
                        labs(title = "Dye Experiment: Mean Speed",
                             subtitle = "All Speed Values") +
                        xlab("Speed (cm/s)") +
                        ylab("Counts") + theme_classic()
hist_maxspeed <- ggplot(dyedata, aes(x = max_speed)) + geom_histogram() +
                        labs(title = "Dye Experiment: Max Speed",
                             subtitle = "All Max Speeds") +
                        xlab("Maximum Speed (cm/s)") +
                        ylab("Counts") + theme_classic()
hist_activ <- ggplot(dyedata, aes(x = activity_ratio)) + geom_histogram() +
                        labs(title = "Dye Experiment: Activity",
                             subtitle = "All Activity Values") +
                        xlab("Ratio of Frames Spent Active to Total Frames") +
                        ylab("Counts") + theme_classic()
hist_maxaccel <- ggplot(dyedata, aes(x = max_acceleration)) + geom_histogram() +
                        labs(title = "Dye Experiment: Max Acceleration",
                             subtitle = "All Max Acceleration Values") +
                        xlab("Maximum Acceleration (cm/s^2)") +
                        ylab("Counts") + theme_classic()
hist_dist <- ggplot(dyedata, aes(x = totaldist_cm)) + geom_histogram() +
