...
#mean shoal area
d_shoal <- glmmTMB(shoal_area ~ treatment*experiment + (1|tankID),
...
#ratio of space use
d_space <- update(d_shoal, space_use ~ ., family = beta_family(link = "logit"))
...
plot(simulateResiduals(fittedModel = d_space)) #assumptions borderline
...
#mean shoal area
m_shoal <- glmmTMB(shoal_area ~ treatment*experiment*time + (1|tankID),
